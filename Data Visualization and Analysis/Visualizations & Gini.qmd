...
Testing proportion of negative responsibility attributions against 0.5

```{r}
prop.test(61, 129, 0.5)
prop.test(27, 69, 0.5)
```
...
ggsave("RQ5aplot.png", plot = RQ5aplot, path = '/Users/lukefischer/Desktop', width = 8.33, height= 4, units = "in")
```
...
ggsave("RQ5bplot.png", plot = RQ5bplot, path = '/Users/lukefischer/Desktop', width = 8.33, height= 4, units = "in")
```
...
reliability_table <- tibble(
  Variable =  
    c("Presence", "Sender Relevance", "Evaluation", "Presence Individual", "Specific Individual", "Presence Collective", "Specific Collective", "Presence Systems", "Specific Systems", "Presence Network", "Specific Network", "Economy", "Politics & Human Rights", "External Relations", "Social Policies & Welfare"), 
  K_Alpha = 
...
reliabilityplot <- reliability_table |> 
  ...
  theme(plot.title.position = "plot", axis.text = element_text(size = 14)) 



ggsave("reliabilityplot.png", plot = reliabilityplot, path = '/Users/lukefischer/Desktop', width = 11.5, height= 5.5, units = "in")
```
